...
public class UserController {
    ...
    public ResponseEntity<User> login(@RequestBody User user){
        ...
        if (userDetail!=null && userDetail.getUserPassword().equals(user.getUserPassword())) {
    ...
    public ResponseEntity<User> updateUserPassword(@RequestBody User user){
        User userDetail = userService.findUserByName(user);
        if(userDetail!=null){
            User updatedUser = userService.updateUserPassword(userDetail, user.getUserPassword());
